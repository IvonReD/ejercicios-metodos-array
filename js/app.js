...
/* ------- Ejemplo  2  (opcional)de filter ------ */
// var evenNumbers = numberArray.filter(function(array) {
//   //Escribe tu codigo aquí.
//   return array % 2==0;
// });
...
/* ------- Ejemplo  2  (opcional)de filter numeros impares ------ */
// var oddNumbers = numberArray.filter(function(array) {
//   //Escribe tu codigo aquí
//  return array % 2==1;
// });
...
var reducer = function(outputReducer) {
  ...
  console.log(par);
  var impar = outputReducer.filter(array => array %2 !=0).reduce((prev, cur) => prev + cur, 0);
...
//   var filterTags = persons.filter(function(elemento) {
//   return elemento.id;
//   });
...
/*** ----- Ejemplo 1 ----***/
 var filterData = function(array) {
   ...
   var newArrayTags = newArray.map(function (item) {
     return item.tags;
   });
   // return newArray;
...
/*** ----- Ejemplo 3 ----***/
var searchTags = persons.filter(function (elemento) {
